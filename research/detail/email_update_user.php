...
if ($json) {
    ...
    $mail->AltBody = 'หัวเรื่องบทความวิจัย ' . $research_name . ' ได้เปลี่ยนสถานะเป็น '. $research_status . '<br>' .'ตรวจสอบสถานะการส่งบทความวิจัยได้ที่เว็บไซต์  '. '<a href="http://service.science.swu.ac.th">http://service.science.swu.ac.th</a> นี้ <br>' . 'ขอบคุณครับ';
    $mail->Body = 'หัวเรื่องบทความวิจัย ' . $research_name . ' ได้เปลี่ยนสถานะเป็น '. $research_status . '<br>' .'ตรวจสอบสถานะการส่งบทความวิจัยได้ที่เว็บไซต์  '. '<a href="http://service.science.swu.ac.th">http://service.science.swu.ac.th</a> นี้ <br>' . 'ขอบคุณครับ';
